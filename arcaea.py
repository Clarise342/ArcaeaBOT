...
async def latest(ctx):
  ...
  e.timestamp = dt.utcnow()
  e.add_field(name="◆ 曲の追加",value="Ephemeral Pageパックに3曲を追加",inline=False)
  e.add_field(name="◆ パートナー情報の追加",value="アリス&テニエルに情報を追加",inline=False)
  e.add_field(name="◆ パック情報の変更",value="Ephemeral Pageパックの情報を変更",inline=False)
